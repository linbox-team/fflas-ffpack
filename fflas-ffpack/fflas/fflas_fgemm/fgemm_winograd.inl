...
namespace FFLAS { namespace Protected {
        ...
        inline int WinogradSteps (const Field & F, const size_t & m)
        {
            ...
            //              MMHelper<Field, MMHelperAlgo::Winograd, FieldMode> & HC)
        ...
        DynamicPeeling2 (const Field& F,
                         ...
                         typename Field::Element_ptr C, const size_t ldc,
                         MMHelper<Field, MMHelperAlgo::Winograd, FieldMode> & H,
                         const MMHelper<Field, MMHelperAlgo::Winograd, FieldMode> & HC)
        // const typename MMHelper<Field, MMHelperAlgo::Winograd, FieldMode>::DelayedField::Element Cmin,
        // const typename MMHelper<Field, MMHelperAlgo::Winograd, FieldMode>::DelayedField::Element Cmax)
        {
...
// #else
        ...
        Protected::DynamicPeeling2 (F, ta, tb, m, n, k, mr, nr, kr, alpha, A, lda, B, ldb, beta, C, ldc, H, HC);
// #endif
        return C;
    } // fgemm
...
///
            ...
            // Then w >0
        MMHelper<Field, MMHelperAlgo::Winograd, ModeT> Hcopy(H);
            // typedef typename  MMHelper<Field, MMHelperAlgo::Winograd, ModeT>::DelayedField::Element DFElt;
            // DFElt Cmin = H.Cmin;
            // DFElt Cmax = H.Cmax;
#ifdef OLD_DYNAMIC_PEELING
        ...
        Protected::DynamicPeeling (F, ta, tb, m, n, k, m&0x1, n&0x1, k&0x1, alpha, A, lda, B, ldb, beta, C, ldc, HC, Hcopy);
#else
        ...
        FFLASFFPACK_check(k == k2*2+kr);
        MMHelper<Field, MMHelperAlgo::Winograd, ModeT> HC(H);
        Protected::DynamicPeeling2 (F, ta, tb, m, n, k, mr, nr, kr, alpha, A, lda, B, ldb, beta, C, ldc, HC, Hcopy);
#endif
        return C;
    } // fgemm
