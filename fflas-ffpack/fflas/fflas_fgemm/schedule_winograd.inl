...
//          WAIT;
                              ...
                              )
        {
            ...
            // std::cerr<<std::endl<<"T3H = "<<T3H<<std::endl;
                // S3 = A11 - A21 in X1
            ...
            // std::cerr<<std::endl<<"S3H = "<<S3H<<std::endl;

                // P7 = alpha . S3 * T3  in C21
            MMH_t H7(F, WH.AlgoManager.recLevel-1, S3H.ModeManager.Out, T3H.ModeManager.Out);
            fgemm (F, ta, tb, mr, nr, kr, alpha, X1, ldX1, X2, ldX2, F.zero, C21, ldc, H7);
            // std::cerr<<std::endl<<"H7 = "<<S3H<<std::endl;
            ...
            Operand<Field,typename TryLazy<Field>::value> B22H(WHMM.B);
            MMH_t H3 (F, WH.AlgoManager.recLevel-1, S4H.ModeManager.Out, B22H);
            ...
            // }
            AddSubHelper<Field,typename TryLazy<Field>::value> U2H (F, H1.ModeManager.Out, H6.ModeManager.Out);
            ...
            // }
            AddSubHelper<Field,typename TryLazy<Field>::value> U3H (F, H7.ModeManager.Out, U2H.ModeManager.Out);
            ...
            //     freduce (F, mr, nr, C12, ldc);
            // }
            AddSubHelper<Field,typename TryLazy<Field>::value> U4H (F, H5.ModeManager.Out, U2H.ModeManager.Out);
            ...
            //     freduce (F, mr, nr, C22, ldc);
            // }
            AddSubHelper<Field,typename TryLazy<Field>::value> U7H (F, H5.ModeManager.Out, U3H.ModeManager.Out);
            ...
            Operand<Field,typename TryLazy<Field>::value> A22H(WHMM.A);
            MMH_t H4(F, WH.AlgoManager.recLevel-1, A22H,  T4H.ModeManager.Out);
            ...
            //     freduce (F, mr, nr, C21, ldc);
            // }
            AddSubHelper<Field,typename TryLazy<Field>::value> U6H (F, U3H.ModeManager.Out, H4.ModeManager.Out);
            ...
            //     freduce (F, mr, nr, C11, ldc);
            // }
            AddSubHelper<Field,typename TryLazy<Field>::value> U1H (F, H2.ModeManager.Out, H1.ModeManager.Out);
