...
namespace FFLAS{
	...
	inline void pfspmv(const Field & F, const Sparse<Field, SparseMatrix_t::CSR> & A, typename Field::ConstElement_ptr x,
...
#else
		// The minimum size has to be a multiple of cache_line/sizeof(Element) to avoid cache coherency problem (ex: 8 for double, 16 for float)
