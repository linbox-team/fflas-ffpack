...
namespace FFLAS{
	...
	inline void fspmm(const Field & F, const Sparse<Field, SparseMatrix_t::CSR_HYB> & A, int blockSize, typename Field::ConstElement_ptr x,
	...
	template<class Field>
	inline void fspmm(const Field & F, const Sparse<Field, SparseMatrix_t::CSR_HYB> & A, int blockSize, typename Field::ConstElement_ptr x, int ldx,
