...
int main(int argc, char** argv) {
  ...
  /**
     PS: the function Solve will modify the matrix A so here we used a duplicate matrix A2 otherwise A*x will not be equal to b for the later verification stage except for some special case
  */
