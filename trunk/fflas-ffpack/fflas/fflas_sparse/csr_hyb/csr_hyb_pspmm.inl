...
namespace FFLAS{
	...
	inline void pfspmm(const Field & F, const Sparse<Field, SparseMatrix_t::CSR_HYB> & A, int blockSize, typename Field::ConstElement_ptr x,
...
#pragma omp parallel for
	...
	template<class Field>
	inline void pfspmm(const Field & F, const Sparse<Field, SparseMatrix_t::CSR_HYB> & A, int blockSize, typename Field::ConstElement_ptr x, int ldx,
