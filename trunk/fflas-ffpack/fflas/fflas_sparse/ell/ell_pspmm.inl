...
namespace FFLAS{
	...
	inline void pfspmm(const Field & F, const Sparse<Field, SparseMatrix_t::ELL> & A, int blockSize, typename Field::ConstElement_ptr x,
...
#pragma omp parallel for
	...
	template<class Field>
	inline void pfspmm(const Field & F, const Sparse<Field, SparseMatrix_t::ELL> & A, int blockSize, typename Field::ConstElement_ptr x, int ldx,
...
#pragma omp parallel for
	...
	inline void pfspmm_zo(const Field & F, const Sparse<Field, SparseMatrix_t::ELL_ZO> & A, int blockSize, typename Field::ConstElement_ptr x,
...
#pragma omp parallel for
	...
	template<class Field, class Func>
	inline void pfspmm_zo(const Field & F, const Sparse<Field, SparseMatrix_t::ELL_ZO> & A, int blockSize, typename Field::ConstElement_ptr x, int ldx,
...
#pragma omp parallel for
	...
	inline void pfspmm_zo(const Field & F, const Sparse<Field, SparseMatrix_t::ELL_ZO> & A, int blockSize, typename Field::ConstElement_ptr x,
		      typename Field::Element_ptr y, VectFunc && vfunc, ScalFunc && scalfunc, LFunc && lfunc, SFunc && sfunc){
		using simd = Simd<typename Field::Element>;
		using vec_t = typename simd::vec_t;
#ifdef __FFLASFFPACK_USE_TBB
		tbb::parallel_for(
