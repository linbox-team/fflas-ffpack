...
namespace FFLAS{
	...
	inline void fspmm(const Field & F, const Sparse<Field, SparseMatrix_t::CSR> & A, int blockSize, typename Field::ConstElement_ptr x,
	...
	template<class Field>
	inline void fspmm(const Field & F, const Sparse<Field, SparseMatrix_t::CSR> & A, int blockSize, typename Field::ConstElement_ptr x, int ldx,
	...
	inline void fspmm_zo(const Field & F, const Sparse<Field, SparseMatrix_t::CSR_ZO> & A, int blockSize, typename Field::ConstElement_ptr x,
	...
	template<class Field, class Func>
	// inline typename  std::enable_if<std::is_function<Func>::value>::type
	inline void fspmm_zo(const Field & F, const Sparse<Field, SparseMatrix_t::CSR_ZO> & A, int blockSize, typename Field::ConstElement_ptr x, int ldx,
