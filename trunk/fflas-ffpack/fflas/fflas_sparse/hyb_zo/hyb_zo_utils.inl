...
// #define HYB_ZO_DEBUG 1
	...
	inline void sparse_init(const Field & F, Sparse<Field, SparseMatrix_t::HYB_ZO> & A,
		...
		index_t *colOne = nullptr, *colMOne = nullptr, *colOther = nullptr, *rowOne = nullptr, *rowMOne = nullptr, *rowOther = nullptr;
		if(nOnes){
